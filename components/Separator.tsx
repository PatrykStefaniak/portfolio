    ...
    return (
        ...
        >
            <div ref={elRef} className="w-[90%] sm:w-[55%] mx-auto p-px">
                {isInView && (
                    <div className="animate-fade-in sm:w-[60vh] mx-auto py-[500vh] mt-[40vh] px-5 sm:p-20 bg-(--bg-light)/30 text-(--text) text-center mt-[25vh] rounded-xl shadow-2xl border-t border-(--border-muted)">
