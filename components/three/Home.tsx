...
export default function Main() {
    return <div id="container" className="overflow-clip">
        <div className="bg-radial-[at_5%_5%] to-(--bg-dark) from-(--bg) fixed inset-0 ">
            <Background />
        </div>
        <main className="z-10 relative">
            <section className="w-[90%] sm:w-[55%] mx-auto p-px h-[100vh]">
                <div className="animate-fade-in sm:w-[60vh] mx-auto py-15 px-5 sm:p-20 bg-(--bg-light)/90 text-(--text) text-center mt-[25vh] rounded-xl shadow-2xl border-t border-(--border-muted)">
